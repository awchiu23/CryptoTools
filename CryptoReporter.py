...
def ftxInit(ftx,spotBTC,spotETH,spotFTT):
...
class core:
  ...
  def run(self):
    if self.exch=='ftx':
      ...
      self.nav, self.liq, self.mf, self.mmReq, self.freeCollateral = ftxInit(self.api,self.spotBTC,self.spotETH,self.spotFTT)
    elif self.exch=='bb':
